<!-- Pagina de Login de usuario. STATUS: COMPLETE -->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    list ($check, $data) = check_login($dbc, $_POST['matricula'], $_POST['pass']);
...
<head>
    ...
    <title>Iniciar Sesión - Bazar Borrego </title>
    <!-- CSS -->
           ...
           <div class="form-bottom">
               <form role="form" action="login.php" method="post" class="registration-form">
                <div class="form-group">
                 ...
                 <input type="text" name="matricula" placeholder="Matrícula" minlength = "9" maxlength="9" class="form-first-name form-control" id="form-first-name">
             </div>
             <div class="form-group">
