...
if (isset($_GET['pid']) && filter_var($_GET['pid'], FILTER_VALIDATE_INT, array('min_range' => 1)) ) {
 ...
 $q = "SELECT id_residencia, titulo, precio, terreno, cuarto, descripcion, ubicacion, renta_venta, usuario.nombre, usuario.apellido, usuario.id_usuario, email FROM residencia, usuario WHERE id_residencia = $pid AND id_usuario = ref_usuario";
            ...
            <div class="col-md-12">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><?php echo "<b>{$row['titulo']}";?>
                        <br>
                        </h4>
                        <h4><?php echo "Contacto: {$row['nombre']} {$row['apellido']}";?></h4>
                        <h4><?php echo "Matrícula: {$row['id_usuario']} ";?></h4>
                        <h4><?php echo "Correo: {$row['email']}";?></h4>
                        <h4><?php echo "Terreno: {$row['terreno']} m^2";?></h4>
                        <h4><?php echo "Ubicación: {$row['ubicacion']}";?></h4>
                        <h4><?php echo "Cuartos Disponibles: {$row['cuarto']}";?></h4>
                        <h4><?php echo "Estado: {$row['renta_venta']}";?></h4>
                        <br>
