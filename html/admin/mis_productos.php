...
<head>
  ...
  <title>Mis Productos - Bazar Borrego</title>
            ...
            <div class="col-md-12">
              <?php
                ...
                if (!isset($_SESSION['id_usuario'])) {
                  ...
                  $q = "SELECT id_producto, nombre_producto, marca, estado, nombre_categoria, descripcion, precio FROM producto, categoria, usuario WHERE usuario.id_usuario = '$mat' AND ref_usuario = usuario.id_usuario AND ref_categoria = id_categoria AND fecha_pub BETWEEN NOW() - INTERVAL 30 DAY AND NOW() ORDER BY producto.nombre_producto ASC";
                  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $q = "SELECT producto.id_producto, producto.nombre_producto, producto.marca, producto.estado, categoria.nombre_categoria, producto.descripcion, producto.precio 
              ...
              <h2 class="page-title">Mis Productos</h2>
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <form method="post" action="busqueda_productos.php" class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label">Marca/Autor</label>
                            <div class="col-sm-10">
                    ...
                    <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC)) {
                          ...
                          <td>\${$row['precio']}</td>
                          <td>
                      <a class=\"btn btn-primary\" href=\"editar_productos.php?id_dep={$row['id_producto']}\">
                      Editar
                      </a>
                      </td>
                          <td>
                          <form action=\"conf_eliminar_producto.php\" method=\"post\">
