...
<head>
	...
	<title>Mis Departamentos - Bazar Borrego</title>
...
if (!isset($_SESSION['id_usuario'])) {
  ...
  exit();  
	...
	$q = "SELECT id_residencia, titulo, ubicacion, renta_venta, precio, terreno, cuarto FROM residencia,usuario WHERE residencia.ref_usuario = usuario.id_usuario AND id_usuario = '$mat' AND fecha_pub BETWEEN NOW() - INTERVAL 30 DAY AND NOW() ORDER BY fecha_pub DESC";
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		AND ubicacion LIKE '%$b_ubicacion%' AND id_usuario = '$mat' 
...
?>
						<h2 class="page-title">Mis Departamentos</h2>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" action="mis_departamentos.php" class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-2 control-label">Título</label>
												<div class="col-sm-10">
													<input type="text" name="b_titulo" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Ubicación</label>
												<div class="col-sm-10">
													<input type="text" name="b_ubicacion" class="form-control">
												</div>
											</div>
							...
							<div class="panel panel-default">
							<div class="panel-heading">Departamentos / Recuerda: solo se muestran aquellos anuncios de los ultimos 30 dias</div>
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC)) {
											...
											<td>{$row['terreno']}</td>
											<td>
											<a class=\"btn btn-primary\" href=\"editar_departamentos.php?id_dep={$row['id_residencia']}\">
											Editar
											</a>
											</td>
											<td>
											<form action=\"conf_eliminar_departamento.php\" method=\"post\">
											<input type=\"hidden\" name=\"id_residencia\" value=\"{$row['id_residencia']}\" />
											<button class=\"btn btn-primary\" type=\"submit\">Eliminar
											</button>
											</form>
											</td>
											</tr>\n";
