    ...
    echo '<div class="ts-main-content">
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <form class="form-horizontal" action="eliminar_departamento.php" method="post">
            <input type="hidden" name="id_residencia" value="<?php echo $id_residencia;?>"/>
          <p class="alert alert-error">Estas seguro que quieres eliminar este departamento ?</p>
